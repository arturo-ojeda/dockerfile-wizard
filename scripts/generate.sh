...
echo "RUN echo 'mysql-server mysql-server/root_password password rana045' | debconf-set-selections "
echo "RUN echo 'mysql-server mysql-server/root_password_again password rana045' | debconf-set-selections "
